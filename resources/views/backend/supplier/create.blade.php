            ...
            <div class="col-12">
                <div class="card mb-4 rounded-0">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">{{__('pages.create_supplier')}}</h6>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="company_name" id="company_name" value="{{old('company_name')}}" placeholder="{{__('pages.company_name')}}" class="form-control" aria-describedby="emailHelp" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{__('pages.contact_person')}}</label>
                                        <input type="text" name="name" id="name" value="{{old('name')}}" placeholder="{{__('pages.contact_person')}}" class="form-control" aria-describedby="emailHelp">
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" id="phone" value="{{old('phone')}}" placeholder="{{__('pages.phone_number')}}" class="form-control" aria-describedby="emailHelp" required>
                                        @if ($errors->has('phone'))
