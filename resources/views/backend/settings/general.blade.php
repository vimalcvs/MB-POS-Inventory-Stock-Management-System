                    ...
                    <div class="card-body">
                        <form action="{{route('save-application-setting')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row  pt-3">
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        <label for="vat_reg_no">{{__('pages.vat_reg_number')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        <label for="default_customer">{{__('pages.default_customer')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="app_date_format">{{__('pages.date_format')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="app_timezone">{{__('pages.timezone')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-3 mt-3">
                                    <div class="form-group">
                                        <label for="app_logo">{{__('pages.app_logo')}} <span class="text-danger">*</span></label>

                                        <div class="upload-img-box">
                                            @if(get_option('app_logo') != '')
                                                <img src="{{asset(get_option('app_logo'))}}">
                                            @else
                                                <img src="">
                                            @endif
                                            ...
                                            <div class="upload-img-box-icon">
                                                ...
                                                <p class="m-0">{{__('pages.app_logo')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
                                    <div class="form-group">
                                        <label for="login_banner">{{__('Login Banner')}} <span class="text-danger">*</span></label>

                                        <div class="upload-img-box">
                                            @if(get_option('login_banner') != '')
                                                <img src="{{asset(get_option('login_banner'))}}">
                                            @else
                                                <img src="">
                                            @endif
                                ...
                                <div class="col-md-3 mt-3">
                                    <div class="form-group">
                                        <label for="app_fav_icon">{{__('pages.app_fav_icon')}} <span class="text-danger">*</span></label>

                                        <div class="upload-img-box">
                                            @if(get_option('app_fav_icon') != '')
                                                <img src="{{asset(get_option('app_fav_icon'))}}">
                                            @else
                                                <img src="">
                                            @endif
                                            ...
                                            <div class="upload-img-box-icon">
                                                <i class="fa fa-camera"></i>
                                                <p class="m-0">{{__('pages.app_fav_icon')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
