            ...
            <div class="col-12">
                <div class="card mb-4 rounded-0">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">{{__('pages.create_branch')}}</h6>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" value="{{old('title')}}" placeholder="{{__('pages.branch_name')}}" class="form-control"  required>
                                        @if ($errors->has('title'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contact_person" id="contact_person" value="{{old('contact_person')}}" placeholder="{{__('pages.contact_person')}}" class="form-control"  required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" id="phone" value="{{old('phone')}}" placeholder="{{__('pages.phone_number')}}" class="form-control"  required>
                                        @if ($errors->has('phone'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" id="address" value="{{old('address')}}" placeholder="{{__('pages.address')}}" class="form-control"  required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" id="short_description" placeholder="{{__('pages.short_description')}}" class="form-control">{{old('short_description')}}</textarea>
