...
<main>
    <div id="details" class="clearfix">
        <div id="client"class="mt-10">
            <h2 class="name"><?php echo e(__('pages.purchase_statistics')); ?></h2>
        </div>
    </div>
    ...
    <table class="table" width="100%" cellspacing="0">
            <thead>
                <tr class="bg-secondary text-white">
                    ...
                    <th scope="col"><?php echo e(__('pages.branch')); ?></th>
                    <?php endif; ?>
...
<?php /**PATH E:\server\MAMP\htdocs\pos\mbpos\resources\views/backend/pdf/reports/purchase/statistics.blade.php ENDPATH**/ ?>