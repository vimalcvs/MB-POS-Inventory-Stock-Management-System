        ...
        <div class="col-12">
            <div class="card mb-4 rounded-0">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive" <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access_to_all_branch')): ?> style="margin-top: -5px;" <?php endif; ?>>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\server\MAMP\htdocs\pos\package\resources\views/backend/report/stock/index.blade.php ENDPATH**/ ?>