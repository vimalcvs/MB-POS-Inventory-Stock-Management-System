				...
				<div class="card mb-4 rounded-0">
					...
					<div class="card-header p-0">
                        ...
                        <div class="btn-group btn-group-sm" role="group" style="position: absolute; right: 0">
                            <form action="<?php echo e(url('report/sell/statistics-pdf')); ?>" method="get">
                            ...
                            <form action="<?php echo e(url('report/sell/statistics-pdf')); ?>" method="get" target="_blank">
                                <?php echo $__env->make('backend.report.sell.partial.hidden-filter-value-pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('/backend/js/partial/sale-report-statistics-filter.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\server\MAMP\htdocs\pos\package\resources\views/backend/report/sell/statistics/filter-result.blade.php ENDPATH**/ ?>