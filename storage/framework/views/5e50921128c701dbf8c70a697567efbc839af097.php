        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-4 rounded-0">
                    ...
                    <div class="product-card-header card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <div class="row w-100 p-0">
                            <div class="col-md-10">
                                <form action="<?php echo e(route('product-filter')); ?>" method="get">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                           <button type="submit" class="btn btn-primary"><?php echo e(__('pages.search')); ?></button>
                                        </div>
                                    </div>
                                </div>
                                </form>
                            ...
                            <div class="col-md-2 p-0">
                                <div class="float-right">
                                    <a href="<?php echo e(route('product.create')); ?>" class="btn btn-secondary rounded-0"><i class="fa fa-plus"></i> <?php echo e(__('pages.create_product')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\server\MAMP\htdocs\pos\package\resources\views/backend/product/index.blade.php ENDPATH**/ ?>